...
extension ImagePipeline {
    ...
    public enum Error: Swift.Error, CustomStringConvertible, @unchecked Sendable {
        ...
        case dataLoadingFailed(urlResponse: URLResponse?, error: Swift.Error)
        /// Data loader returned empty data.
        case dataIsEmpty(urlResponse: URLResponse?)
        ...
        case decodingFailed(urlResponse: URLResponse?, decoder: any ImageDecoding, context: ImageDecodingContext, error: Swift.Error)
        /// Processor failed to produce a final image.
        case processingFailed(urlResponse: URLResponse?, processor: any ImageProcessing, context: ImageProcessingContext, error: Swift.Error)
...
extension ImagePipeline.Error {
    ...
    public var dataLoadingError: Swift.Error? {
        switch self {
        case .dataLoadingFailed(_, let error):
            return error
        default:
            return nil
        }
    ...
    public var description: String {
        ...
        case let .dataLoadingFailed(_, error):
        ...
        case let .decodingFailed(_, decoder, _, error):
        ...
        case let .processingFailed(_, processor, _, error):
